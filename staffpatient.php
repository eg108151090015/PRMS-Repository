...
<body>
        ...
        <div class="container-fluid mt-4">
            <div class="card shadow-sm border-0">
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr >";
                    echo "<td onclick=\"window.location='staff_viewpatient.php?patient_id=" . $row['patient_id'] . "'\" style=\"cursor:pointer;\">" . $count++ . "</td>";
                    echo "<td onclick=\"window.location='staff_viewpatient.php?patient_id=" . $row['patient_id'] . "'\" style=\"cursor:pointer;\">" . htmlspecialchars($row['last_name']) . "</td>";
                    echo "<td onclick=\"window.location='staff_viewpatient.php?patient_id=" . $row['patient_id'] . "'\" style=\"cursor:pointer;\">" . htmlspecialchars($row['first_name']) . "</td>";
                    echo "<td onclick=\"window.location='staff_viewpatient.php?patient_id=" . $row['patient_id'] . "'\" style=\"cursor:pointer;\">" . htmlspecialchars($row['middle_name']) . "</td>";
                    echo "<td onclick=\"window.location='staff_viewpatient.php?patient_id=" . $row['patient_id'] . "'\" style=\"cursor:pointer;\">" . htmlspecialchars($row['gender']) . "</td>";
                    echo "<td onclick=\"window.location='staff_viewpatient.php?patient_id=" . $row['patient_id'] . "'\" style=\"cursor:pointer;\">" . htmlspecialchars($row['date_of_birth']) . "</td>";
                    echo "<td onclick=\"window.location='staff_viewpatient.php?patient_id=" . $row['patient_id'] . "'\" style=\"cursor:pointer;\">" . htmlspecialchars($row['age']) . "</td>";
                    echo "<td onclick=\"window.location='staff_viewpatient.php?patient_id=" . $row['patient_id'] . "'\" style=\"cursor:pointer;\">" . htmlspecialchars($row['contact_number']) . "</td>";
                    echo "<td onclick=\"window.location='staff_viewpatient.php?patient_id=" . $row['patient_id'] . "'\" style=\"cursor:pointer;\">" . htmlspecialchars($row['email_address']) . "</td>";
                    echo "<td onclick=\"window.location='staff_viewpatient.php?patient_id=" . $row['patient_id'] . "'\" style=\"cursor:pointer;\">" . htmlspecialchars($row['created_at']) . "</td>";
                    echo '<td>
                            <a href="staff_viewpatient.php?patient_id=' . $row['patient_id'] . '&edit=true" class="btn btn-sm btn-warning text-white">
    ...
    <div class="modal fade" id="archiveModal" tabindex="-1" aria-labelledby="archiveModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" action="staff_deletepatient.php">
                <div class="modal-content">
