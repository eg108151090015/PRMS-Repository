...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="print_allpatients.php" class="btn btn-primary">
                ...
                <!-- Generate Daily, Weekly, Monthly Patient Count -->
                <div class="col-md-4">
                    <div class="card text-center h-100 shadow-sm">
                        <div class="card-body">
                            <i class="bi bi-bar-chart-fill fs-1 text-warning mb-3"></i>
                            <h5 class="card-title">Generate Patient Reports</h5>
                            <p class="card-text">View the total number of patients for a specific day, week, or month.</p>
    ...
    <div class="modal fade" id="reportModal" tabindex="-1" aria-labelledby="reportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header bg-custom text-white fw-bold">
                    <h5 class="modal-title" id="reportModalLabel">Generate Patient Count Reports</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="generate_patient_report.php" method="GET" target="_blank">
                        ...
                        <button type="submit" class="btn btn-primary w-100"><i class="bi bi-bar-chart-line"></i> Generate Report</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    document.getElementById('searchInput').addEventListener('input', function () {
        ...
        if (query.length >= 2) {
            fetch('search_patientreport.php?query=' + encodeURIComponent(query))
